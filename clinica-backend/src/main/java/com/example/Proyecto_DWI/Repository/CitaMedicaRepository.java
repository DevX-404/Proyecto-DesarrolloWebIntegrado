...
public interface CitaMedicaRepository extends JpaRepository<CitaMedica, Long> {
    ...
    @Query("SELECT c FROM CitaMedica c WHERE c.medico.id = :medicoId AND c.fechaCita BETWEEN :inicioDia AND :finDia AND c.estado != com.example.Proyecto_DWI.Model.EstadoCita.CANCELADA")
